    ...
    const wchar_t *path, IFolderOperationsExtractCallback *callback)
{
  ...
  CExtractCallbackImp *ExtractCallbackSpec = (CExtractCallbackImp*)callback;//转换回CExtractCallbackImp以便获取覆盖方式
  ...
  extractCallbackSpec->InitForMulti(false, pathMode,ExtractCallbackSpec->OverwriteMode);
