    ...
    IUpdateCallbackUI *callback)
{
  ...
  if (volumesSizes.Size() == 0)
  {
    ...
    else
    {
      ...
      if (!isOK)
      {
        ...
        errorInfo.Message = L"CoolRAR cannot open file";
        return E_FAIL;
      }
    }
  }
  ...
  if (sfxMode)
  {
    ...
    {
      errorInfo.SystemError = ::GetLastError();
      errorInfo.Message = L"CoolRAR cannot open SFX module";
    ...
    IUpdateCallbackUI2 *callback)
{
  ...
  if (options.SfxMode)
  {
    ...
    {
      errorInfo.SystemError = ::GetLastError();
      errorInfo.Message = L"CoolRAR cannot find specified SFX module";
  ...
  if (createTempFile)
  {
    try
    {
      ...
      if (thereIsInArchive)
        ...
        {
          errorInfo.SystemError = ::GetLastError();
          errorInfo.Message = L"CoolRAR cannot delete the file";
      ...
      {
        errorInfo.SystemError = ::GetLastError();
        errorInfo.Message = L"CoolRAR cannot move the file";
  ...
  if (options.EMailMode)
  {
    ...
    {
      errorInfo.SystemError = ::GetLastError();
      errorInfo.Message = L"CoolRAR cannot load Mapi32.dll";
      return E_FAIL;
    }
    ...
    {
      errorInfo.SystemError = ::GetLastError();
      errorInfo.Message = L"CoolRAR cannot find MAPISendDocuments function";
      return E_FAIL;
    }
