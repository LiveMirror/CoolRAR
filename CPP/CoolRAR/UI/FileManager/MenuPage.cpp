...
static LPCWSTR kSystemTopic = L"fm/plugins/CoolRAR/options.htm#system";
...
bool CMenuPage::OnInit()
{
  ...
  CheckButton(IDC_SYSTEM_INTEGRATE_TO_CONTEXT_MENU,NZipRootRegistry::CheckDragDropHandler());
  #endif
