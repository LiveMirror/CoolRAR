...
static LPCWSTR kShellExtName = L"CoolRAR Shell Extension";
...
static LPCTSTR kDropHandler = TEXT("CLSID\\{23170F69-40C1-278A-1000-000100020001}\\shellex\\DropHandler");
static LPCWSTR kDropClsid = L"{23170F69-40C1-278A-1000-000100020001}";
...
static BOOL RegisterServer(CLSID clsid, LPCWSTR title)
{
  ...
  //×¢²áDropHandler
  NRegistry::CKey Dropkey;
  Dropkey.Create(HKEY_CLASSES_ROOT,kDropHandler);
  Dropkey.SetValue(NULL,kDropClsid);
